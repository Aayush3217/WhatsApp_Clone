...
export const useChatStore = create((set, get) => ({
    ...
    initsocketListners: () => {
        ...
        //handle remove message from local stoarge
        ...
        // handle any messages sending error
        ...
        // emit status check all users in conversation list
    ...
    fetchConversations: async () => {
        ...
        try {
            ...
            set({
                errer: error?.response?.data?.message || error?.message,
                loading: false
            });
            return null;
        }
    ...
    fetchMessages: async (conversationId) => {
        ...
        try {
            const { data } = await axiosInstance.get(`/chats/conversation/${conversationId}/messages`);
