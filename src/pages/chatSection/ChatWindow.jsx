...
const ChatWindow = ({ selectedContact, setSelectedContact, isMobile }) => {
  ...
  const { messages, loading, sendMessage, receiveMessage, fetchMessages, fetchConversations, conversations, isUserTyping, stopTyping, startTyping, getUserLastSeen, isUserOnline, cleanup, addReactions, deleteMessage } = useChatStore();
  ...
  // console.log('this is my selected contact', selectedContact)
      ...
      {filePreview && (
        <div className='relative p-2'>
          ...
          <button
            ...
            className='absolute top-1 bg-red-500 hover:bg-red-600 text-white rounded-full p-1'
          >
